...
The files under `fixtures/` are **third-party, included verbatim solely as
...
Licenses currently represented: Apache-2.0 (incl. LLVM exception), MIT,
BSD-3-Clause, Artistic-2.0, PSF-2.0, and GPL-2.0-only
(`gfw-vcpkg-copy-dlls.bat`, from Git for Windows). They are aggregated here for
testing only ("mere aggregation"); see each `.LICENSE` for terms.
